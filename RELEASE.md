...
cleanup. The v0.3.0 GitHub Release and Zenodo archive are complete. CRAN
remains deferred unless separately planned.
...
- Do not rewrite or replace the v0.2.0 GitHub Release, tag, or Zenodo
  archive.
- Do not rewrite or replace the v0.3.0 GitHub Release, tag, or Zenodo
  archive.
